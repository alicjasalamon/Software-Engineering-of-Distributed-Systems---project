...
/**
 * Base class of repository of Application\Entity\Event document.
 */
abstract class EventRepository extends \Mandango\Repository
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $this->documentClass = 'Application\Entity\Event';
        $this->isFile = false;
        $this->collectionName = 'application_entity_event';
